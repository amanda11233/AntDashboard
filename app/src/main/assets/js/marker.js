function Marker(poiData) {
    ...
    */
    ...
    this.markerDrawableIdle = new AR.ImageDrawable(World.markerDrawableIdle, 10, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawableSelected = new AR.ImageDrawable(World.markerDrawableSelected, 10, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(50), 1.5, {
        zOrder: 1,
        translate: {
            y: 0.55
        },
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(150), 1, {
        zOrder: 1,
        translate: {
            y: -0.55
        },
